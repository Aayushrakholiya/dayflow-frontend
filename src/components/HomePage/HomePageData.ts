/*  
*  FILE          : HomePageData.ts 
*  PROJECT       : PROG3221 - capstone
*  PROGRAMMER    : Ayushkumar Rakholiya, Jal Shah, Darsh Patel and Virajsinh Solanki 
*  FIRST VERSION : 2026-02-01 
*  DESCRIPTION   : 
*    Data and interfaces for homepage sections including nav links, feature cards, and preview events.
*/
...
// Links rendered in the navbar — label is the display text, href is the scroll target
...
// Sample events displayed in the hero preview card
